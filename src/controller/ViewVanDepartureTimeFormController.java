...
public class ViewVanDepartureTimeFormController {
    ...
    public void forSearchField(){
        ...
        vehicle.setSQL("Select number,firstName,lastName,arrivalTime,departureTime from vanParkingTempory where number = ?");
        try {
            Vehicle v = VehicleController.getValuesForCashier(vehicle,txtSearchNumber.getText(),"Van");
            if (v!=null) {
