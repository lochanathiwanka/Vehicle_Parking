...
public class ViewBusDepartureTimeFormController {
    ...
    public void forSearchField(){
        ...
        vehicle.setSQL("Select number,firstName,lastName,arrivalTime,departureTime from busParkingTempory where number = ?");
        try {
            Vehicle v = VehicleController.getValuesForCashier(vehicle,txtSearchNumber.getText(),"Bus");
            if (v!=null) {
