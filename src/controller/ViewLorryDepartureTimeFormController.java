...
public class ViewLorryDepartureTimeFormController {
    ...
    public void forSearchField(){
        ...
        vehicle.setSQL("Select number,firstName,lastName,arrivalTime,departureTime from lorryParkingTempory where number = ?");
        try {
            Vehicle v = VehicleController.getValuesForCashier(vehicle,txtSearchNumber.getText(),"Lorry");
            if (v!=null) {
